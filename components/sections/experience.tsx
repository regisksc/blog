...
export function ExperienceSection() {
  ...
  return (
    <div data-fragment-key="experience" data-focus-visible="true" className={`flex flex-col transition-opacity duration-300 ease-out ${showContent ? "opacity-100" : "opacity-0"}`}>
