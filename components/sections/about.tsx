...
export function AboutSection() {
  ...
  return (
    <div data-fragment-key="about" data-respects-reduced-motion="true" className={`flex flex-col gap-6 sm:gap-8 transition-opacity duration-300 ${showContent ? "opacity-100" : "opacity-0"}`}>
      <AsciiBanner />
